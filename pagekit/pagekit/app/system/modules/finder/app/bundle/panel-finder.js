...
/***/ function(module, exports, __webpack_require__) {
	...
	if (__vue_script__ &&
	  ...
	  console.warn("[vue-loader] app\\system\\modules\\finder\\app\\components\\panel-finder.vue: named exports in *.vue files are ignored.")}
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  var id = "C:\\Users\\Matteo\\Desktop\\Code\\publicsandbox\\pagekit\\pagekit\\app\\system\\modules\\finder\\app\\components\\panel-finder.vue"
	  if (!module.hot.data) {
	...
	module.exports = {
	    ...
	    watch: {
	        ...
	        view: function view(_view) {
	            this.$session.set('finder.' + this.root + '.view', _view);
	        },
	    ...
	    partials: {
	        ...
	        table: __webpack_require__(4),
	        thumbnail: __webpack_require__(5)
